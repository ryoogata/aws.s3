...
This package is not yet on CRAN. To install the latest stable version from GitHub, run the following:

```R
install.packages("aws.s3", repos = c(getOptions("repos"), "http://cloudyr.github.io/drat"))
```

or first add [the cloudyr drat repository](https://github.com/cloudyr/cloudyr.github.io/tree/master/drat/src/contrib) to your default repositories so you can install packages without the complicated argument above:
...
If credentials have been generated in the AWS console and made available in R, you can find your available buckets using:
